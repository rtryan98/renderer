...
VS_Out main(uint vertex_index : SV_VertexID, uint vertex_offset : SV_StartVertexLocation)
{
    VS_Out vs_out;
    Imgui_Vert vert = rhi::uni::buf_load_arr<Imgui_Vert>(pc.vertex_buffer_idx, vertex_index + vertex_offset);
