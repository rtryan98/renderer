...
{
    float3 ucs = ren::color::spaces::Rec2020_Jzazbz(input);
    float3 skewed_rgb = evaluate_gt7_curve(input, tone_map_parameters);
    float3 skewed_ucs = ren::color::spaces::Rec2020_Jzazbz(skewed_rgb);
    ...
    float3 scaled_rgb = ren::color::spaces::Jzazbz_Rec2020(scaled_ucs);
