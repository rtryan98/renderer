...
void main(uint3 id : SV_DispatchThreadID)
{
    ...
    float4 x_y_z_xdx_ranges = min_max_values.x_y_z_xdx.cascades[id.z].max_values - min_max_values.x_y_z_xdx.cascades[id.z].min_values;
    float4 ydx_zdx_ydy_zdy_ranges = min_max_values.ydx_zdx_ydy_zdy.cascades[id.z].max_values - min_max_values.ydx_zdx_ydy_zdy.cascades[id.z].min_values;

    // Move into 0.0 - 1.0 range
    float4 x_y_z_xdx = rhi::uni::tex_load_arr<float4>(pc.x_y_z_xdx_tex, id.xy, id.z);
    x_y_z_xdx -= min_max_values.x_y_z_xdx.cascades[id.z].min_values;
    ...
    ydx_zdx_ydy_zdy -= min_max_values.ydx_zdx_ydy_zdy.cascades[id.z].min_values;
