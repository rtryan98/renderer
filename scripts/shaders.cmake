set(RENDERER_DXC_ARGS -enable-16bit-types -HV 2021 -no-legacy-cbuf-layout -Zpr -O3)
...
function(renderer_compile_builtin_shader SHADER_FILE_PATH)
    ...
    if (${SHADER_FILE_PATH} MATCHES "\.vs\.hlsl")
        set(RENDERER_BUILTIN_SHADER_PROFILE "-T vs_6_8")
    ...
    elseif(${SHADER_FILE_PATH} MATCHES "\.ps\.hlsl")
        set(RENDERER_BUILTIN_SHADER_PROFILE "-T ps_6_8")
    elseif(${SHADER_FILE_PATH} MATCHES "\.cs\.hlsl")
        set(RENDERER_BUILTIN_SHADER_PROFILE "-T cs_6_8")
    elseif(${SHADER_FILE_PATH} MATCHES "\.gs\.hlsl")
        set(RENDERER_BUILTIN_SHADER_PROFILE "-T gs_6_8")
        set(RENDERER_DXC_STAGE_SPV_ARGS ${RENDERER_DXC_STAGE_SPV_ARGS} -fvk-invert-y -fvk-use-dx-position-w)
    elseif(${SHADER_FILE_PATH} MATCHES "\.hs\.hlsl")
        set(RENDERER_BUILTIN_SHADER_PROFILE "-T hs_6_8")
    elseif(${SHADER_FILE_PATH} MATCHES "\.ds\.hlsl")
        set(RENDERER_BUILTIN_SHADER_PROFILE "-T ds_6_8")
        set(RENDERER_DXC_STAGE_SPV_ARGS ${RENDERER_DXC_STAGE_SPV_ARGS} -fvk-invert-y -fvk-use-dx-position-w)
    elseif(${SHADER_FILE_PATH} MATCHES "\.as\.hlsl")
        set(RENDERER_BUILTIN_SHADER_PROFILE "-T as_6_8")
    elseif(${SHADER_FILE_PATH} MATCHES "\.ms\.hlsl")
        set(RENDERER_BUILTIN_SHADER_PROFILE "-T ms_6_8")
    elseif(${SHADER_FILE_PATH} MATCHES "\.lib\.hlsl")
        set(RENDERER_BUILTIN_SHADER_PROFILE "-T lib_6_8")
    else()
    ...
    add_custom_command(
        ...
        COMMAND dxc.exe ${RENDERER_DXC_FULL_ARGS} -Fo ${RENDERER_BUILTIN_SHADER_FILEPATH}/${RENDERER_BUILTIN_FILENAME}.dxil ${SHADER_FILE_PATH}
        COMMAND dxc.exe ${RENDERER_DXC_FULL_SPV_ARGS} -Fo ${RENDERER_BUILTIN_SHADER_FILEPATH}/${RENDERER_BUILTIN_FILENAME}.spv ${SHADER_FILE_PATH}
