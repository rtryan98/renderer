...
if __name__ == '__main__':
    ...
    for shader_json_file in args.shader_json_files:
        ...
        pipeline_string, metadata, name, fn_args, fn_switches, first_element, permutation_sizes, fn_arg_names, has_permutations = generate_permutations(json_object, "." + shader_source_path, args.binary_base_path + shader_source_path.replace(".hlsl", ""))
